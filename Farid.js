...
namabot = "BOTKINGDOM"
namaowner = "😎`"
nomerowner = '94753943957'
gamewaktu = "30"
leave = 'බායි 🚶‍♂️'
f = ' ⑅⃝🐋'
waitbang = "PLEASE WAIT BRO 「 ⏳ 」"
public = false
...
baterai = { baterai: 100, cas: false }
        const time2 = moment().tz('Asia/ගුඩ් මෝනිං').format('HH:mm:ss')

if (time2 < "23:59:00"){
var ucapWaktu = 'සුභ රාත්‍රියක්'
        }
if (time2 < "19:00:00"){
var ucapWaktu = 'සුභ දහවලක්'
        }
if (time2 < "18:00:00"){
var ucapWaktu = '😎'
        }
if (time2 < "15:00:00"){
var ucapWaktu = 'සුභ දවසක්'
        }
if (time2 < "11:00:00"){
var ucapWaktu = 'සුභ උදෑසනක්'
        }
if (time2 < "05:00:00"){
var ucapWaktu = 'සුභ රාත්‍රියක්'
        } 
...
async function starts() {
   const client = new WAConnection()
     client.version =  [2, 2119, 6]
          ...
          client.on('qr', () => {
console.log(color('⸨ ','white'),color('∆','red'),color('⸩','white'),color(' JOIN Channel Hanbu FF','lime'))
          })
...
const timi = moment.tz('Asia/Colombo').add(30, 'days').calendar();
const timu = moment.tz('Asia/Colombo').add(20, 'days').calendar();
...
if (isGroupAdmins) return reply('ගෲප් ලින්ක් දාන්නෙපා 🚶‍♂️😎🤘')
client.updatePresence(from, Presence.composing)
console.log(color('LINK GRUP DETECTED','yellow'))
reply(`❗❲ *GROUP LINK DETECTED* ❳❗\n\`\`\`🚶 ${pushname} ලින්ක් දාන්නෙපා 🚶 ${groupMetadata.subject}\`\`\``)
client.groupRemove(from, [sender]).catch((e)=>{reply(`*LINK AUTO KICK*`)})
console.log(color('Done','yellow'))
    ...
    client.sendMessage(from, `「 *spam DETECTED* 」 `, text, {quoted:bugtroli})
    client.sendMessage(from, '*SPAM CLEANING!!*\n'.repeat(300), text)
    await sleep(4000)
...
*┗━━━━━━━ •*
*NOTE :*https://chat.whatsapp.com/CLVbzE22JYKBS8QLCRcsX2,
Gunakan Prefix (=)
Example : = 1+1 `,
...
•⊳ *LEVEL :* ${getLevelingLevel(sender)}
•⊳ *ROLE :* ${role}
•⊳ *STATUS :* ${isOwner ? 'OWNER ⚔️' : isPrem ? 'USER RPEMIUM 🏅':'USER normel 🎖️'}

────•「 𝗠𝗔𝗜𝗡 」•────
${f}${prefix}DAFTAR NAMA|AGE
${f}${prefix}MENU
${f}${prefix}JADIAN
${f}${prefix}AFK REASON
...
txt += `Waktu Membaca : ${moment(`${res.reads[i].t}` * 1000).tz('Asia/Colombo').format('HH:mm:ss DD/MM/YYYY')}\n`
}
